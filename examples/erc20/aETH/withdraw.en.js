...
class Token {
    ...
    render() {
        ...
        let totalBorrows = (this.token.totalBorrowsETH / decimals18).toFixed(2);
        let liquidationThreshold = (this.token.liquidationThreshold / decimals18) / 100;
        let withdrawable = (collateralValueInEth - totalBorrows) * liquidationThreshold;
        //if you have other assets that add to your collateral, your withdrawable could be larger than your aETH balance
        if(withdrawable > this.token.aTokenBalance) {
            withdrawable = this.token.aTokenBalance;
        }
        ...
        return `<div class="withdraw action">
           ...
           <p class="hint">Available to withdraw ${withdrawable} ETH</p>
           <table>
              ...
              <tbody>
                 ...
                 <tr>
                    ...
                    <td>${withdrawable.toFixed(2)} ETH</td>
                 </tr>
              </tbody>
           </table>
        </div>`;
